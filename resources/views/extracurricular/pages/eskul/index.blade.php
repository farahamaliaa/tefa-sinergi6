...
<form action="{{ route('extracurricular.list') }}" method="GET" class="d-flex gap-2 mt-4">
            ...
            <div class="card bg-ekstra border shadow-none">
                <div class="p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('extracurricular.students.index', ['extracurricular' => $extracurricular->id]) }}" class="text-primary">
