                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h6 class="fs-4 fw-semibold mb-0">
                                                {{ $attendance->extracurricularStudent->student->user->name }}
                                            </h6>
                                            <span
                                                class="fw-normal fs-2">{{ $attendance->extracurricularStudent->student->gender == 'male' ? 'Laki-laki' : 'Perempuan' }}</span>
                                        </div>
                                    </div>
                                </td>
