                        ...
                        @forelse ($todaySchedules as $index => $schedule)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (!$existingJournal)
                                        <a href="{{ route('extracurricular.journal.create', ['extracurricular' => $extracurricular->id, 'schedule' => $schedule->id]) }}"
                                    ...
                                    @else
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="{{ route('extracurricular.journal.show', ['id' => $existingJournal->id]) }}"
                                                class="btn btn-sm d-inline-flex align-items-center justify-content-center"
                                                style="background-color: #E0F2FE; color: #0284C7; width: 32px; height: 32px;">
                                                <i class="ti ti-eye fs-5"></i>
                                            </a>
                                            <a href="{{ route('extracurricular.journal.edit', ['id' => $existingJournal->id]) }}"
                                                class="btn btn-sm d-inline-flex align-items-center justify-content-center"
                ...
                <div class="card w-100 shadow-sm border" style="border-radius: 8px; overflow: hidden;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                            @if ($journal->is_filled)
                                <a href="{{ route('extracurricular.journal.show', ['id' => $journal->id]) }}"
