...
@section('content')
    ...
    <div class="card card-body">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                ...
                <div class="" style="min-width: 200px;">
                    ...
                    <select name="day" class="form-select" onchange="this.form.submit()">
                        ...
                        @foreach(App\Enums\DayEnum::cases() as $day)
                            <option value="{{ $day->value }}" {{ request('day') == $day->value ? 'selected' : '' }}>{{ ucfirst($day->label()) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="" style="min-width: 200px;">
                    <label class="form-label">Jam Mulai</label>
                    <input type="time" name="start_time" class="form-control" onchange="this.form.submit()" value="{{ request('start_time') }}">
                </div>
                <div class="d-flex align-items-center" style="min-height: 40px;"> {{-- Adjust min-height to align with input --}}
                    <span class="fw-bold fs-5">-</span>
                </div>
                <div class="" style="min-width: 200px;">
                    <label class="form-label">Jam Selesai</label>
                    <input type="time" name="end_time" class="form-control" onchange="this.form.submit()" value="{{ request('end_time') }}">
                </div>
                <div>
            ...
            <div>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create-schedule">
...
<div class="card card-body">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="text-muted">
            Menampilkan {{ $extracurricularStudents->currentPage() }} dari {{ $extracurricularStudents->lastPage() }} halaman
        </div>
        <div>
