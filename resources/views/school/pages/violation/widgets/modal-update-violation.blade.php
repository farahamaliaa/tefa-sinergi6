<div class="modal fade" id="modal-update-violation" tabindex="-1" aria-labelledby="createRFID" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="violation" id="violation-edit" class="form-control" placeholder="Nama pelanggaran">
                        </div>
                        <div class="form-group mt-3">
                            <h6 class="mb-2">Point : </h6>
                            <input type="number" name="point" id="point-edit" class="form-control" placeholder="Point">
                        </div>
                    </div>
                </div>
