    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-white" id="importPegawai">Import Jadwal Pelajaran</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('school.import-spreadsheet') }}" method="POST" enctype="multipart/form-data">
                @method('post')
                @csrf
                <div class="modal-body">
                    <div class="card p-3 mb-4" style="background-color: #FFF5E3;">
                        ...
                        <div class="ms-4">
                            <a href="{{ route('school.classroom.template.schedule') }}" class="btn btn-primary">
