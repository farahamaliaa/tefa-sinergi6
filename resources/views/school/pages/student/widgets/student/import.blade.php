<!-- modal import -->
<div class="modal fade" id="import-student" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 rounded-4 overflow-hidden">

            <div class="modal-header border-0 py-3" style="background:#1AA6D8;">
                <h5 class="modal-title text-white">Import Siswa</h5>
            ...
            <form action="{{ route('school.class.student.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="info-card p-4 rounded-3 mb-4">
                        ...
                        <ul class="ms-3 mb-3">
                            <li>Jika siswa tidak terimport maka kemungkinan email siswa tersebut telah digunakan.</li>
                        ...
                        <a href="{{ route('school.class.download.template') }}" class="btn btn-primary rounded px-3 d-inline-flex align-items-center gap-1">
