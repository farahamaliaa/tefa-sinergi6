...
<div class="row g-3">
    <div class="col-md-6 col-lg-4">
        <div class="stat-card border">
            <div>
                <div class="stat-title">Jumlah Guru Telat Absen</div>
                <div class="stat-badge bg-primary-soft">{{ $lates_teacher->count() }} Guru</div>
            </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="stat-card border">
            <div>
                <div class="stat-title">Jumlah Guru Izin</div>
