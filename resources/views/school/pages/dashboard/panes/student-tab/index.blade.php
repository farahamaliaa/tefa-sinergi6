<style>
    .stat-card {
    min-height: 160px;          /* 🔼 lebih tinggi */
    padding: 30px 24px;         /* ruang dalam lebih lega */
    display: flex;
    align-items: center;
    ...
    margin-bottom: 15px; /* biar antar card gak nempel juga */
    }

    .stat-section {
    margin-bottom: 20px; /* 🔹 kasih ruang di bawah */
    }
    ...
    .icon-box {
    width: 72px;                /* 🔼 ikon sedikit lebih besar */
    height: 72px;
    border-radius: 14px;
    display: flex;
