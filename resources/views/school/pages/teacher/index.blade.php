    ...
    <div class="row">
        <div class="col-lg-12 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn mb-1 btn-primary btn-lg px-4 fs-4 font-medium text-end"
                                    ...
                                    <div class="row mx-3 ">
                                        <div class="col-md-12">
                                            ...
                                            <input type="file" name="image" id="image"
                                                class="form-control mt-2 mb-3" onchange="previewImage(event)">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" placeholder="Masukkan no telp" name="phone_number"
                                                    class="form-control mb-3" pattern="[0-9]*" inputmode="numeric"
                                                    maxlength="13" value="{{ old('phone_number') }}">
                                                @error('phone_number')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                            </div>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <span
                                        class="fw-normal">{{ $teacher->gender == 'male' ? 'Laki Laki' : 'Perempuan' }}</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span
                                class="badge {{ $teacher->active == '1' ? 'bg-light-primary text-primary' : 'bg-light-danger text-danger' }}">{{ $teacher->active == '1' ? 'Aktif' : 'Tidak Aktif' }}</span>
                        </td>
                        <td>{{ $teacher->nip }}</td>
                            ...
                            <form id="form-edit" class="tab-wizard wizard-circle wizard clearfix" role="application"
                                ...
                                <section>
                                    <div class="row mx-3">
                                        <div class="col-md-12">
                                            <label for="" class="mb-2">Foto Guru (opsional)</label>
                                            <img id="employeeImagePreview" src="#" alt="Preview"
                                                style="max-width: 200px; display: none; height: auto;">
                                            <input type="file" name="image" id="employeeImage"
                                                class="form-control mt-2 mb-3" onchange="previewEmployeeImage(event)">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Nama <span class="text-danger"
                                                        style="font-size: larger;">*</span></label>
                                                <input type="text" name="name" placeholder="Masukkan nama"
                                                    id="name-edit" class="form-control mb-3"
                                                    value="{{ old('name') }}">
                                                @error('name')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">NIP <span class="text-danger"
                                                        style="font-size: larger;">*</span></label>
                                                <input type="number" name="nip" placeholder="Masukkan nip"
                                                    id="nip-edit" class="form-control mb-3"
                                                    value="{{ old('nip') }}">
                                                @error('nip')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Tempat Lahir <span class="text-danger"
                                                        style="font-size: larger;">*</span></label>
                                                <input type="text" placeholder="Masukkan tempat lahir"
                                                    class="form-control" id="birth_place-edit" name="birth_place"
                                                    value="{{ old('birth_place') }}">
                                                @error('birth_place')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nik" placeholder="Masukkan nik"
                                                    id="nik-edit" class="form-control mb-3"
                                                    value="{{ old('nik') }}">
                                                @error('nik')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="phone_number" placeholder="Masukkan no telp"
                                                    id="phone-edit" class="form-control mb-3" pattern="[0-9]*"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" placeholder="Masukkan email"
                                                    id="email-edit" class="form-control mb-3"
                                                    value="{{ old('email') }}">
                                                @error('email')
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                @enderror
