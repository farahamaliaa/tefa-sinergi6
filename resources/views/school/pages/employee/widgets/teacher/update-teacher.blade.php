        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                <div class="wizard-content">
                    <form id="form-update" class="tab-wizard wizard-circle wizard clearfix" role="application"
                            ...
                            <div class="row mx-3">
                                <div class="col-md-12 text-center mb-4">
                                    <div id="drop-zone-edit"
                                        ...
                                        <img id="employeeImagePreview" class="rounded-circle"
                                        ...
                                        <input type="file" name="image" id="employeeImage"
                                            onchange="previewEditTeacherImage(event)" style="display:none">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="Masukkan nama" id="name-edit"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">NIP <span class="text-danger"
                                                style="font-size: larger;">*</span></label>
                                        <input type="number" name="nip" placeholder="Masukkan nip" id="nip-edit"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="religion_id" id="edit-religion-teacher"
                                        ...
                                        @error('religion_id', 'update')
                                            <strong
                                                class="text-danger error-edit-teacher mb-2">{{ $message }}</strong>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Tanggal Lahir <span class="text-danger"
                                                style="font-size: larger;">*</span></label>
                                        <input type="date" name="birth_date" id="birth_date-edit-teacher"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Masukkan tempat lahir"
                                            class="form-control rounded-input" id="birth_place-edit-teacher"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check d-flex align-items-center mt-2">
                                        ...
                                        <div class="custom-control custom-radio me-4">
                                            <input type="radio" class="custom-control-input" id="femaleEdit"
                        ...
                        <section>
                            <div class="row mx-3 pt-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nik" placeholder="Masukkan nik"
                                            id="nik-edit" class="form-control rounded-input mb-3"
                                            value="{{ old('nik') }}">
                                        @error('nik', 'update')
                                            <strong
                                                class="text-danger error-edit-teacher mb-2">{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">No Telp <span class="text-danger"
                                                style="font-size: larger;">*</span></label>
                                        <input type="tel" name="phone_number" placeholder="Masukkan no telp"
                                            id="phone-edit" class="form-control rounded-input mb-3" pattern="[0-9]*"
                                            inputmode="numeric" maxlength="13" value="{{ old('phone_number') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" placeholder="Masukkan email"
                                            id="email-edit" class="form-control rounded-input mb-3"
                                            value="{{ old('email') }}">
                                        @error('email', 'update')
                                            <strong
                                                class="text-danger error-edit-teacher mb-2">{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="active" id="status-edit"
                                            class="form-select rounded-input mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" placeholder="Masukkan alamat" id="address-edit" class="form-control rounded-input mb-3"
                            ...
                            <div class="d-flex justify-content-end mt-3 mx-4">
                                <button type="button"
                                    class="btn mb-1 waves-effect waves-light btn-rounded btn-primary ms-3 prev-step"
