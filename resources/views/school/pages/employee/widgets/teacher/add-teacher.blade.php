...
<div class="modal fade" id="create-teacher" tabindex="-1" aria-labelledby="guru" aria-hidden="true">
                    ...
                    <div class="wizard-content">
                        <form action="{{ route('school.teacher.store') }}" class="tab-wizard wizard-circle wizard clearfix"
                            ...
                            <section>
                                <div class="row mx-3 mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div id="drop-zone" class="mb-3" style="border:2px dashed #DCE9EF; border-radius:8px; padding:28px; text-align:center; background:#FBFDFF;">
                            ...
                            <section>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Masukkan no telp" name="phone_number"
                                                class="form-control rounded-input mb-3" value="{{ old('phone_number') }}">
                                ...
                                <div class="d-flex justify-content-end mt-3 mx-4">
                                    <button type="button"
                                        class="btn mb-1 waves-effect waves-light btn-rounded btn-primary ms-3 prev-add-step"  style="background:#098FC6; border-color:#098FC6;">Kembali</button>
                                    <button type="submit"
                                        class="btn mb-1 waves-effect waves-light btn-rounded btn-primary ms-3 next-add-step" style="background:#098FC6; border-color:#098FC6;">Simpan</button>
                                </div>
                            </section>
                        </form>
                    </div>
    ...
    <style>
        ...
        #drop-zone label.btn { display:inline-block; }
        #drop-zone.drag-over { border-color: #098FC6; background: #EEF9FF; }
    </style>
</div>
