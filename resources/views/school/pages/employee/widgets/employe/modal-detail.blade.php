...
<div class="modal fade" id="modal-detail" tabindex="-1" aria-labelledby="importPegawai" aria-hidden="true">
        ...
        <div class="modal-content modal-lg">
            <div class="modal-header p-0" style="border:none;">
                <div style="background-color: #1AA6D8; width:100%; padding: 14px 20px; border-top-left-radius: .5rem; border-top-right-radius: .5rem; display:flex; align-items:center; justify-content:space-between;">
                    <h5 class="modal-title text-white mb-0" id="importPegawai">Detail Pegawai</h5>
            ...
            <div class="modal-body pt-4 pb-4">
                ...
                <div class="row mt-3 px-4">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <p id="phone-detail" class="detail-field mb-0 text-start"></p>
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <p id="nip-detail" class="detail-field mb-0 text-start"></p>
                    </div>
                    <div class="col-12 col-md-6 mb-3">
    ...
    <style>
        ...
        #modal-detail .modal-content { border-radius: 12px; overflow: hidden; }
