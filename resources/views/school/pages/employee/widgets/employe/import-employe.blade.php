    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <div class="modal-header border-0 py-3" style="background:#1AA6D8;">
                <h5 class="modal-title text-white">Import Pegawai</h5>
            ...
            <form action="{{ route('school.staff.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="info-card p-4 rounded-3 mb-4">
                        ...
                        <a href="{{ route('school.staff.download-template') }}" class="btn btn-primary rounded px-3 d-inline-flex align-items-center gap-1">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn btn-primary rounded px-4" style="background:#098FC6; border-color:#098FC6;">Tambah</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const modal = document.getElementById('import-employe');
