        ...
        <div class="modal-content">
            <div class="modal-header p-0" style="border:none;">
                <div style="background-color: #1AA6D8; width:100%; padding: 12px 20px; border-top-left-radius: .5rem; border-top-right-radius: .5rem; display:flex; align-items:center; justify-content:space-between;">
                    <h5 class="modal-title text-white mb-0" id="addEmployee">Tambah Pegawai</h5>
                ...
                <div class="wizard-content">
                    <form action="{{ route('school.staff.store') }}" id="add-form"  class="tab-wizard wizard-circle wizard clearfix" role="application" method="POST" enctype="multipart/form-data">
                        ...
                        <section>
                            <div class="row mx-3">
                                <div class="col-md-12 text-center mb-4">
                                    <div id="drop-zone-add-emp" style="position:relative; width:150px; height:150px; margin:0 auto; border:2px dashed #DCE9EF; border-radius:50%; display:flex; align-items:center; justify-content:center; background:#FBFDFF; cursor:pointer; transition:all 0.3s ease;">
                                        <img id="addImagePreviewEmp" class="rounded-circle" src="{{ asset('assets/images/default-user.jpeg') }}" alt="Preview" style="object-fit: cover; width: 150px; height: 150px; position:absolute; z-index:2;" onerror="this.onerror=null;this.src='{{ asset('assets/images/default-user.jpeg') }}';" />
                                        <div id="drop-zone-overlay-emp" style="position:absolute; width:100%; height:100%; border-radius:50%; display:flex; align-items:center; justify-content:center; z-index:3; opacity:0; transition:opacity 0.3s ease; background: rgba(15, 159, 198, 0.15);">
                                        ...
                                        <div id="drop-zone-initial-icon-emp" style="position:absolute; width:100%; height:100%; border-radius:50%; display:flex; align-items:center; justify-content:center; z-index:1; pointer-events:none;">
                                        ...
                                        <input type="file" name="image" id="imageInput" onchange="previewAddEmployeeImage(event)" style="display:none">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Nama <span class="text-danger" style="font-size: larger;">*</span></label>
                                        <input type="text" name="name" placeholder="Masukkan nama" class="form-control rounded-input mb-3" value="{{ old('name') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nip" placeholder="Masukkan NIP" class="form-control rounded-input mb-3" value="{{ old('nip') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrapper">
                                            <select name="religion_id" id="" class="form-select rounded-input select-icon">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="birth_date" class="form-control rounded-input mb-3" value="{{ old('birth_date') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rounded-input" placeholder="Masukkan tempat lahir" name="birth_place" value="{{ old('birth_place') }}">
                        ...
                        <section>
                            <div class="row mx-3 pt-4">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nik" placeholder="Masukkan NIK" class="form-control rounded-input mb-3" value="{{ old('nik') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" placeholder="Masukkan nomor telepon" class="form-control rounded-input mb-3" value="{{ old('phone_number') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" placeholder="Masukkan Email" class="form-control rounded-input mb-3" value="{{ old('email') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrapper">
                                            <select name="active" id="" class="form-select rounded-input mb-3 select-icon">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" placeholder="Masukkan alamat" class="form-control rounded-input mb-3" rows="3">{{ old('address') }}</textarea>
                            ...
                            <div class="d-flex justify-content-end mt-3 mx-4">
                                <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-primary ms-3 prev-add-step" style="background:#098FC6; border-color:#098FC6;">Kembali</button>
...
<style>
    .rounded-input { border-radius: 10px; background: #F6F9FB; border: 1px solid rgba(0,0,0,0.06); height: 45px; }
    ...
    #drop-zone-add-emp:hover {
        border-color: #098FC6;
        background: #EEF9FF;
    }
    #drop-zone-add-emp:hover #drop-zone-overlay-emp {
        opacity: 1 !important;
    }
    #drop-zone-add-emp:hover #drop-zone-initial-icon-emp {
        opacity: 0;
    }
    #drop-zone-add-emp.drag-over {
        border-color: #098FC6;
        background: #EEF9FF;
    }
    #drop-zone-add-emp.drag-over #drop-zone-overlay-emp {
        opacity: 1 !important;
    }
    #drop-zone-add-emp.drag-over #drop-zone-initial-icon-emp {
        opacity: 0;
    }
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const dropZone = document.getElementById('drop-zone-add-emp');
        ...
        dropZone.addEventListener('drop', function (e) {
            ...
            if (files && files.length) {
                ...
                previewAddEmployeeImage({ target: fileInput });
            }
        });
    });

    function previewAddEmployeeImage(e) {
        const input = e.target;
        if (input.files && input.files[0]) {
            const url = URL.createObjectURL(input.files[0]);
            const preview = document.getElementById('addImagePreviewEmp');
            preview.src = url;
        }
    }
</script>
