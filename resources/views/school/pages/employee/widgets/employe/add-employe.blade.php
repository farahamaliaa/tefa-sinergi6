        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                <div class="wizard-content">
                    <form action="{{ route('school.staff.store') }}" id="add-form"
                        class="tab-wizard wizard-circle wizard clearfix" role="application" method="POST"
                            ...
                            <div class="row mx-3">
                                <div class="col-md-12 text-center mb-4">
                                    <div id="drop-zone-add-emp"
                                        ...
                                        <img id="addImagePreviewEmp" class="rounded-circle"
                                        ...
                                        <div id="drop-zone-initial-icon-emp"
                                        ...
                                        <input type="file" name="image" id="imageInput"
                                            onchange="previewAddEmployeeImage(event)" style="display:none">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @error('name', 'create-employee')
                                            <strong
                                                class="text-danger error-create-employee mb-2">{{ $message }}</strong>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rounded-input"
                                            placeholder="Masukkan tempat lahir" name="birth_place"
