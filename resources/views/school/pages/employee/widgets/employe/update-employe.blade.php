                ...
                <div class="wizard-content">
                    <form id="form-edit-employee" class="tab-wizard wizard-circle wizard clearfix" role="application" method="POST" enctype="multipart/form-data">
                        ...
                        <section id="step1-edit-employee">
                            <div class="row mx-3">
                                <div class="col-md-12 text-center mb-4">
                                    <div id="drop-zone-edit-emp" style="position:relative; width:150px; height:150px; margin:0 auto; border:2px dashed #DCE9EF; border-radius:50%; display:flex; align-items:center; justify-content:center; background:#FBFDFF; cursor:pointer; transition:all 0.3s ease;">
                                        <img id="editImagePreviewEmp" class="rounded-circle" src="{{ asset('assets/images/default-user.jpeg') }}" alt="Preview" style="object-fit: cover; width: 150px; height: 150px; position:absolute; z-index:2;" onerror="this.onerror=null;this.src='{{ asset('assets/images/default-user.jpeg') }}';" />
                                        <div id="drop-zone-overlay-edit-emp" style="position:absolute; width:100%; height:100%; border-radius:50%; display:flex; align-items:center; justify-content:center; z-index:3; opacity:0; transition:opacity 0.3s ease; background: rgba(15, 159, 198, 0.15);">
                                        ...
                                        <div id="drop-zone-initial-icon-edit-emp" style="position:absolute; width:100%; height:100%; border-radius:50%; display:flex; align-items:center; justify-content:center; z-index:1; pointer-events:none;">
                                        ...
                                        <input type="file" name="image" id="edit-image-input" onchange="previewEditEmployeeImage(event)" style="display:none">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Nama <span class="text-danger" style="font-size: larger;">*</span></label>
                                        <input type="text" name="name" id="edit-name" placeholder="Masukkan nama" class="form-control rounded-input mb-3" value="{{ old('name') }}">
                                        @error('name', 'update')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nip" placeholder="Masukkan NIP" id="edit-nip" class="form-control rounded-input mb-3" value="{{ old('nip') }}">
                                        @error('nip', 'update')
                                        <strong class="text-danger error-edit-employee mb-2">{{ $message }}</strong>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for=""><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align: -2px; margin-right: 4px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-13c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z" fill="#2B3E4B"/></svg>Agama</label>
                                        <div class="select-wrapper">
                                            <select name="religion_id" id="edit-religion" class="form-select rounded-input select-icon">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="birth_date" id="edit-birth-date" class="form-control rounded-input mb-3" value="{{ old('birth_date') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rounded-input" placeholder="Masukkan tempat lahir" id="edit-birth-place" name="birth_place" value="{{ old('birth_place') }}">
                        ...
                        <section id="step2-edit-employee">
                            <div class="row mx-3 pt-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nik" id="edit-nik" placeholder="Masukkan nik" class="form-control rounded-input mb-3" value="{{ old('nik') }}">
                                        @error('nik', 'update')
                                        <strong class="text-danger error-edit-employee mb-2">{{ $message }}</strong>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" id="edit-phone" placeholder="Masukkan no telp" class="form-control rounded-input mb-3" value="{{ old('phone_number') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" id="edit-email" placeholder="Masukkan email" class="form-control rounded-input mb-3" value="{{ old('email') }}">
                                        @error('email', 'update')
                                        <strong class="text-danger error-edit-employee mb-2">{{ $message }}</strong>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for=""><svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align: -2px; margin-right: 4px;"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zm-5.04-6.71l-2.75 3.54-1.1-1.46L6.5 17h11l-3.96-5.29z" fill="#2B3E4B"/></svg>Status</label>
                                        <div class="select-wrapper">
                                            <select name="active" id="edit-status" class="form-select rounded-input mb-3 select-icon">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="edit-address" placeholder="Masukkan alamat" class="form-control rounded-input mb-3" rows="3">{{ old('address') }}</textarea>
                            ...
                            <div class="d-flex justify-content-end mt-3 mx-4">
                                <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-primary prev-edit-step">Kembali</button>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        dropZone.addEventListener('drop', function (e) {
            ...
            if (files && files.length) {
                ...
                previewEditEmployeeImage({ target: fileInput });
            }
        });
    });
