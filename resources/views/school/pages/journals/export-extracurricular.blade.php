...
@section('content')
    ...
    <div class="card header-wave shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold text-white mb-8">Cetak Jurnal Pembina Ekskul</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-white text-decoration-none" href="javascript:void(0)">
                                    Halaman untuk melakukan export data jurnal pembina ekskul berdasarkan rentang tanggal.
                                </a>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <p class="mb-0 mt-2 text-dark">
                            Lengkapi form dibawah untuk melakukan export jurnal pembina ekskul.
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <td colspan="5" class="text-center align-middle">
                                <div class="d-flex flex-column justify-content-center align-items-center p-4">
                                    ...
                                    <p class="fs-5 text-dark text-center mt-2">
                                        Belum ada data jurnal pembina ekskul
                                    </p>
                                </div>
                            </td>
                        </tr>
    ...
    @include('school.pages.journals.widgets.modal-detail-extracurricular')
@endsection

@section('script')
    <script>
        $('.btn-review').on('click', function() {
            $('#form-action').attr('action', '{{ route('school.extracurricular-journal.export') }}');
        });

        $('.btn-export').on('click', function() {
            $('#form-action').attr('action', '{{ route('school.extracurricular-journal.download') }}');
        });
    </script>
    @include('school.pages.journals.scripts.detail-extracurricular')
@endsection
