    ...
    <div class="card header-wave shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold text-white mb-8">Cetak Jurnal Staff</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-white text-decoration-none" href="javascript:void(0)">
                                    Halaman untuk melakukan export data jurnal staff berdasarkan rentang tanggal.
                                </a>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <p class="mb-0 mt-2 text-dark">
                            Lengkapi form dibawah untuk melakukan export jurnal staff.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <table class="table border text-nowrap customize-table mb-0 align-middle">
                <thead class="fs-4 table-custom-header">
                    <tr>
                        ...
                        <th class="text-white">Nama Staff</th>
