                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="text-white text-decoration-none"
                                    href="javascript:void(0)">Daftar - daftar siswa dan Orang Tua</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            ...
                            <h6 style="font-size: 25px; color: #13DEB9"><b></b></h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="card rounded-3 card-hover border position-relative">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            <h4 class="card-title text-dark"><b>Jumlah Orang Tua</b></h4>
                            <h6 style="font-size: 25px; color: #FFAE1F"><b></b></h6>
                        </div>
                    </div>
                </div>
