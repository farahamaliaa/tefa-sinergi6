    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <div class="modal-header border-0 py-3" style="background:#0896D1;">
                <h5 class="modal-title text-white" id="importParentModalLabel">Import Orang Tua</h5>
                <button type="button" class="btn-close btn-close-white" style="bs-btn-close-color: white !important;" data-bs-dismiss="modal"></button>
            </div>
            ...
            <form action="{{ route('school.parent.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="info-card p-4 rounded-3 mb-4">
                        ...
                        <ul class="ms-3 mb-3">
                            <li>Jika orang tua tidak terimport maka kemungkinan email orang tua tersebut telah digunakan.</li>
                            <li>Password orang tua secara default adalah "password".</li>
                        ...
                        <a href="{{ route('school.parent.download-template') }}" class="btn btn-primary rounded px-3 d-inline-flex align-items-center gap-1">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const modal = document.getElementById('importParentModal');
        // Ensure modal exists
        if (modal) {
