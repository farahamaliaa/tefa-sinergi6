        ...
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <form id="editParentForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                         <div class="col-12 mb-3 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <label for="edit_image" class="position-absolute bottom-0 end-0 text-white rounded-circle p-2 cursor-pointer" style="cursor: pointer; background-color: #0896D1">
                        ...
                        <div class="col-md-6 mb-3">
                         ...
                         <div class="col-md-6 mb-3">
                            <label for="edit_password" class="form-label fw-semibold">Password (Kosongkan jika tidak diubah)</label>
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn text-white" style="background-color: #0896D1;">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
