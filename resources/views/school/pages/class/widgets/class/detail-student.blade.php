            ...
            <div class="modal-content modal-lg">
                ...
                <div class="modal-body px-4 py-4">
                    <div class="row justify-content-center mb-3">
                        <div class="col-auto">
                            <img id="image-detail" src="{{ asset('admin_assets/dist/images/profile/user-1.jpg') }}" class="rounded-circle user-profile"
                                style="object-fit: cover; width: 150px; height: 150px; border: 4px solid #e0e6ed;" alt="User Profile Picture" />
                        </div>
                    </div>
                    <div class="row mt-4">
