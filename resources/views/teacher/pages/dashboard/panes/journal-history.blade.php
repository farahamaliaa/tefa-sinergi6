                    ...
                    <div class="card w-100">
                        <div class="card-header" style="color: #0896D1 !important; background-color: #0896D1 !important;">
                            ...
                            <div class="position-absolute top-0 end-0" style="padding: 0px; position: relative;">
                                <img src="{{ asset('assets/images/background/arrow-leftwarning1.png') }}"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="text-center">
                                                    <span class="badge bg-light-primary fs-7 fw-semibold mb-1 py-2"
                                                        style="color: #0896D1 !important;">{{ $teacherJournal->attendanceJournals->where('status', App\Enums\AttendanceEnum::PERMIT)->count() }}</span>
                                                    <p>Izin</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
