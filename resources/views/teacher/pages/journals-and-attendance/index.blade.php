...
@section('content')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="text-white text-decoration-none"
                                    href="javascript:void(0)">Suyadi Oke</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="card">
        ...
        <ul class="ms-5 pb-2" style="list-style-type:disc;">
            ...
            <li>Ketika guru tidak mengisi jurnal maka pihak sekolah akan menganggap bahwa guru tersebut tidak masuk/mengajar
                        ...
                        <div class="row pb-2" style="border-bottom: 1px solid #c0c0c0">
                            <div class="col-lg-8" style="border-right: 1px solid #c0c0c0;">
                                <div class="pe-3">
                                    ...
                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam, enim sequi. Minima
                                        assumenda tenetur aspernatur dolor quae laboriosam nesciunt reprehenderit!</p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="ps-3">
                                    ...
                                    <div class="row px-3">
                                        <div class="col-lg-3">
                                            <div class="text-center">
                                                <span
                                                    class="badge bg-light-success text-success fs-7 fw-semibold mb-1 py-2">25</span>
                                                <p>Masuk</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
