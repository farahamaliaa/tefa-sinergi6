...
@section('content')
    ...
    <div class="card card-body">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
            ...
            <div>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create-schedule" style="background-color: #098CC3">
        ...
        <div class="col-lg-6 col-md-12 mb-3">
            <form class="d-flex flex-column flex-md-row gap-2" action="/school/students">
                ...
                <div class="d-flex flex-column flex-md-row gap-2">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary btn-md w-100 w-md-auto" style="background-color: #098CC3">Filter</button>
                    </div>
                </div>
            </form>
        </div>
