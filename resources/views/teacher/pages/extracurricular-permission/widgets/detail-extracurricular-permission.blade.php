            ...
            <div class="modal-body p-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="modal-schedule" readonly
                            style="background-color: #F9FAFB; border-color: #E5E7EB; color: #6B7280;">
                    </div>
                </div>
                ...
                <div class="row mb-4 align-items-start">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="2" id="modal-reason" readonly
                ...
                <div class="justify-content-center gap-3 mt-4" id="modal-action-buttons" style="display: none;">
                    <form id="modal-reject-form" method="POST" class="d-inline">
                        @csrf
                    ...
                    <form id="modal-approve-form" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn text-white px-5 py-2"
