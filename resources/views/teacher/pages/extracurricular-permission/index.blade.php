                        ...
                        @forelse ($permissions as $index => $permission)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn text-white px-4" style="background-color: #098FC6;"
                                        ...
                                        data-approve-url="{{ route('teacher.extracurricular-permission.approve', $permission->id) }}"
                                        data-reject-url="{{ route('teacher.extracurricular-permission.reject', $permission->id) }}">
                                        Lihat
                                    </button>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="rejectModal{{ $permission->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form
                                            action="{{ route('teacher.extracurricular-permission.reject', $permission->id) }}"
                                            method="POST">
                                            @csrf
                                            <div class="modal-header" style="background-color: #DC2626;">
                                                <h5 class="modal-title text-white">Tolak Izin</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="rejection_note" class="form-control" rows="3" placeholder="Berikan alasan penolakan..."></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="detailModal{{ $permission->id }}" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #098FC6;">
                                            <h5 class="modal-title text-white">Detail Perizinan</h5>
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <p class="form-control-plaintext">
                                                        {{ $permission->extracurricularStudent->student->user->name }}</p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">Kelas</label>
                                                    <p class="form-control-plaintext">
                                                        {{ $permission->extracurricularStudent->student->classroomStudents->first()?->classroom?->name ?? 'N/A' }}
                                                    </p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">Tanggal</label>
                                                    <p class="form-control-plaintext">
                                                        {{ $permission->date->format('d M Y') }}</p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <p class="form-control-plaintext">
                                                        <span
                                                            class="badge {{ $permission->type == 'sakit' ? 'bg-warning' : 'bg-info' }}">
                                                            {{ ucfirst($permission->type) }}
                                                        </span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <p class="form-control-plaintext">{{ $permission->reason }}</p>
                                                </div>
                                                @if ($permission->attachment)
                                                    <div class="col-12 mb-3">
                                                        <label class="form-label fw-bold">Bukti Surat</label>
                                                        <div>
                                                            <a href="{{ asset('storage/' . $permission->attachment) }}"
                                                                target="_blank">
                                                                <img src="{{ asset('storage/' . $permission->attachment) }}"
                                                                    alt="Bukti Surat"
                                                                    style="max-width: 300px; max-height: 300px; object-fit: cover; border-radius: 5px;">
                                                            </a>
                                                        </div>
                                                    </div>
                                                @endif
