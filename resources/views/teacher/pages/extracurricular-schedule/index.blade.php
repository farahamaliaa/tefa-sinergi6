        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    ...
                    <h6 class="fw-semibold text-white mb-2">Jadwal Kegiatan Ekskul {{ $extracurricular->name }}</h6>
                </div>
                <div class="col-3">
                                ...
                                <div class="modal fade" id="modal-edit-{{ $schedule->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ route('teacher.extracurricular-schedule.update', $schedule->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Batal</button>
                                                <form
                                                    action="{{ route('teacher.extracurricular-schedule.destroy', $schedule->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
