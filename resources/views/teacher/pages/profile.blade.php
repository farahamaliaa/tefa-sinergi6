...
@section('style')
    ...
    <style>
        ...
        /* Decoration circles/waves rough implementation */
        .decoration {
            position: absolute;
            border-radius: 50%;
            ...
            <div class="col-lg-3 mb-4">
                <div class="card card-custom profile-sidebar h-100">
                    ...
                    <div class="card-body text-center pt-2">
                        ...
                        <!-- Edit View for Profile Image (Hidden by default) -->
                        ...
                        <p class="text-muted mb-4 fs-3">{{ $employee->status ?? 'Guru Mapel' }}</p>
                        ...
                        <div class="nav flex-column nav-custom text-start mt-4" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-profile-tab" data-bs-toggle="pill"
                                ...
                                <!-- Reset edit mode when tab switched -->
                ...
                <div class="card card-custom">
                    <div class="card-body p-4 p-md-5">
                        ...
                        @if (request()->session()->has('error'))
                            <!-- sometimes session error handling varies, covering bases -->
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel">
                                ...
                                <div id="profile-read-view">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <label class="form-label-custom">Nama Pembina</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-custom"
                                                value="{{ $classTeacher->name ?? '-' }}" readonly disabled>
                                        </div>
                                    </div>
                                </div>

                                <!-- Edit View (Hidden by default) -->
                                <form id="profile-edit-view" action="{{ route('teacher.profile.update') }}"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label-custom">NIP <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control form-control-custom"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label-custom">NIK <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control form-control-custom"
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label-custom">Alamat <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label-custom">Jabatan <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control form-control-custom"
                                                value="{{ $employee->status ?? '-' }}" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label-custom">Wali Kelas <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control form-control-custom"
                                                value="{{ $classTeacher->name ?? '-' }}" readonly>
                                        </div>
                                    </div>
