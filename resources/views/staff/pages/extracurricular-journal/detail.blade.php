    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('employee.extracurricular-journal.index', ['extracurricular' => $journal->extracurricular_id]) }}"
                    class="btn btn-secondary">
                    <i class="ti ti-arrow-left me-1"></i> Kembali
                </a>
                <div class="d-flex gap-2">
                    <a href="{{ route('employee.extracurricular-journal.edit', ['id' => $journal->id]) }}" class="btn btn-warning">
                        <i class="ti ti-pencil me-1"></i> Edit
                    </a>
                    <form action="{{ route('employee.extracurricular-journal.destroy', ['id' => $journal->id]) }}" method="POST"
