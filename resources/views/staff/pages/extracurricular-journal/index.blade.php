                        ...
                        @forelse ($todaySchedules as $index => $schedule)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (!$existingJournal)
                                        <a href="{{ route('employee.extracurricular-journal.create', ['extracurricular' => $extracurricular->id, 'schedule' => $schedule->id]) }}"
                                    ...
                                    @else
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="{{ route('employee.extracurricular-journal.show', ['id' => $existingJournal->id]) }}"
                                                class="btn btn-sm d-inline-flex align-items-center justify-content-center"
                                                style="background-color: #E0F2FE; color: #0284C7; width: 32px; height: 32px;">
                                                <i class="ti ti-eye fs-5"></i>
                                            </a>
                                            <a href="{{ route('employee.extracurricular-journal.edit', ['id' => $existingJournal->id]) }}"
                                                class="btn btn-sm d-inline-flex align-items-center justify-content-center"
