...
@section('content')
                        ...
                        @foreach ($dummyData as $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($data['status'] == 'Belum Mengisi')
                                        <a href="{{ route('employee.extracurricular-journal.create', ['extracurricular' => request('extracurricular')]) }}"
                                    ...
                                    @else
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            <a href="{{ route('employee.extracurricular-journal.edit', ['id' => 1]) }}"
                                                class="btn btn-sm d-inline-flex align-items-center justify-content-center"
    ...
    @include('staff.pages.journals-extracurricular.wigets.detail')
@endsection
