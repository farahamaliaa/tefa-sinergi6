            ...
            <div class="col-lg-3 mb-4">
                <div class="card card-custom profile-sidebar h-100">
                    ...
                    <div class="card-body text-center pt-2">
                        ...
                        <p class="text-muted mb-4 fs-3">{{ $employee->status ?? 'Staff' }}</p>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel">
                                ...
                                <div id="profile-read-view">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-custom"
                                                value="{{ $employee->gender?->value == 'male' ? 'Laki-laki' : 'Perempuan' }}"
                                                readonly disabled>
                                        </div>
                                ...
                                <form id="profile-edit-view" action="{{ route('employee.profile.update') }}"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="gender" class="form-select form-control-custom" required>
                                                <option value="male"
                                                    {{ old('gender', $employee->gender?->value) == 'male' ? 'selected' : '' }}>
                                                    Laki-laki</option>
                                                <option value="female"
                                                    {{ old('gender', $employee->gender?->value) == 'female' ? 'selected' : '' }}>
                                                    Perempuan</option>
                                            </select>
                                        </div>
