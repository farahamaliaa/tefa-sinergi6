...
@section('style')
    ...
    <style>
        ...
        @media (max-width: 991px) {
            ...
            .mobile-dual .col-lg-6:last-child {
                margin-top: 50px;
            }
        }
    </style>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0" data-aos="fade-right">
                    <span class="hero-label" style="color: #0896D1 !important;">Sistem Operasi Sekolah Generasi Baru</span>
                    <h1 class="hero-title">
                    ...
                    <div class="d-flex align-items-center hero-btns">
                        <a href="{{ route('login') }}" class="btn-glow text-decoration-none text-white"
                            style="background-color: #0896D1 !important;">
                            Masuk Dashboard
                        </a>
                        <a href="#" class="btn-video"
                            style="background-color: #0896D1 !important; color: white !important;">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6">
                    <p style="font-size: 1.1rem; color: #64748b;">
                        Dikembangkan dengan teknologi yang sama dengan startup unicorn dunia. Cepat, handal, dan sangat
                        mudah digunakan.
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Sistem kehadiran otomatis menggunakan kartu pelajar pintar (RFID).
                            Cepat, akurat, dan anti-titip absen.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Visualisasi data langsung membantu Anda mengambil keputusan cerdas
                            seketika.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Aplikasi native untuk iOS dan Android memastikan Anda selalu
                            terhubung di mana saja.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Sistem jurnal digital dan penilaian yang memudahkan tugas harian para
                            guru.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Kelola Jabatan, izin, dan kinerja staff dari satu pusat komando yang
                            efisien.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="feature-card-hover">
                        ...
                        <p class="text-secondary mb-0">Data sensitif sekolah aman dengan enkripsi tingkat bank yang
                            terpercaya.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mobile-content" data-aos="fade-right">
                    ...
                    <p>Seluruh ekosistem Sinergi6 dioptimalkan untuk smartphone Anda. Input nilai, absensi, dan cek jadwal
                        pelajaran secara instan.</p>
                    <div class="d-flex flex-wrap gap-3">
                        <a href="#"
                            style="background: white; color: black; padding: 12px 24px; border-radius: 12px; font-weight: 700; display: inline-flex; align-items: center; text-decoration: none; margin-right: 15px;">
                            <i class="icofont-brand-apple mr-2" style="font-size: 24px;"></i> App Store
                        </a>
                        <a href="#"
                            style="background: transparent; border: 2px solid rgba(255,255,255,0.2); color: white; padding: 12px 24px; border-radius: 12px; font-weight: 700; display: inline-flex; align-items: center; text-decoration: none;">
                    ...
                    @foreach ($schools as $school)
                        <div class="item">
                            <div class="partner-logo-wrapper">
                                <img src="{{ 'https://mischool.mijurnal.com/storage/' . $school['logo'] }}"
                                    alt="Logo Sekolah">
                            </div>
                        </div>
                    @endforeach
