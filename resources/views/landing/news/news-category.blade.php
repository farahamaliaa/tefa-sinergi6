...
@section('banner')
    ...
    <div class="bread_crumb" data-aos="fade-in" data-aos-duration="2000" data-aos-delay="100">
        ...
        <div class="container">
            <div class="bred_text">
                <h1 class="text-primary">Kategori {{ $newsCategory['name'] }}</h1>
                <ul>
                    <li><a href="/">Beranda</a></li>
                    <li><span>»</span></li>
                    <li><a href="news">Berita</a></li>
                    <li><span>»</span></li>
                    <li><a href="news">{{ $newsCategory['name'] }}</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog_left_side">
                        <div class="blog_panel" data-aos="fade-up" data-aos-duration="1500">
                            <div class="main_img">
                                <a href="{{ route('news.detail', $latest['slug']) }}"><img src="{{ $latest ? asset($latest['image']) : '' }}" class="w-100" style="height: 405px; object-fit:cover;" alt="image"></a>
                            </div>
                            <div class="blog_info">
                                    ...
                                    <a href="{{ route('news.detail', ['slug' => $otherNew->slug]) }}">
                                        <div class="custom_d-flex flex-column flex-md-row d-flex">
                                            <div class="custom_img">
                                                <img src="{{ asset($otherNew['image']) }}" style="width:155px; height:145px; object-fit: cover;" alt="image" class="img-fluid" />
                                            </div>
                                    ...
                                    @forelse ($recentPosts as $recentPost)
                                        <li>
                                            <a href="{{ route('news.detail', ['slug' => $recentPost['slug']]) }}">
                                                <div class="img">
                                                    <img src="{{ asset($recentPost['image']) }}" style="width: 75px; height: 75px; object-fit:cover;" alt="image">
                                                </div>
                                                <div class="text">
