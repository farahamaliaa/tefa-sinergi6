    ...
    <nav class="navbar navbar-expand-lg navbar-light px-3 d-flex justify-content-between">
        ...
        <div class="dropdown">
            <a class="d-flex align-items-center gap-2 text-decoration-none" href="#" id="profileDropdown"
                ...
                <img src="{{ (Auth::user()->image && Storage::exists(Auth::user()->image)) ? asset('storage/' . Auth::user()->image) : ((Auth::user()->student && Auth::user()->student->image && Storage::disk('public')->exists(Auth::user()->student->image)) ? asset('storage/' . Auth::user()->student->image) : asset('assets/images/default-user.jpeg')) }}"
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="profileDropdown">
                <li>
                    <a href="{{ route('student.profile') }}" class="dropdown-item d-flex align-items-center gap-2">
